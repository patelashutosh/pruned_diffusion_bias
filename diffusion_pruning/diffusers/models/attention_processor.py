...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        # print("inner_dim = dim_head * heads", inner_dim, dim_head, heads)
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, attention_mask=None, **cross_attention_kwargs):
        ...
        # print("attention_processor hidden_states", hidden_states.size())
    ...
    def head_to_batch_dim(self, tensor, out_dim=3):
        head_size = self.heads
        batch_size, seq_len, dim = tensor.shape
        # print("**** head_to_batch_dim batch_size, seq_len, dim,head_size, tensor.size()", batch_size, seq_len, dim,head_size, tensor.size() )
        # print("**** head_to_batch_dim tensor", tensor )
...
class AttnProcessor:
    def __call__(
        ...
        if input_ndim == 4:
            ...
            # print(" AttnProcessor batch_size, channel, height, width", batch_size, channel, height, width)
        ...
        # print(" AttnProcessor hidden_states, attn.heads", hidden_states.size(),  attn.heads)
        query = attn.to_q(hidden_states)
        # print(" AttnProcessor query", query.size())         
