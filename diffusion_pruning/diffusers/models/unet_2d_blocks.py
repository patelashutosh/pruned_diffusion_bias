...
class AttnDownBlock2D(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, upsample_size=None):
        output_states = ()
        # print("unet_2d_blocks AttnDownblock2D hidden_states", hidden_states.size())
        for resnet, attn in zip(self.resnets, self.attentions):
            # print("AttnDownblock2D before resnet", hidden_states.size())
            hidden_states = resnet(hidden_states, temb)
            # print("AttnDownblock2D after resnet", hidden_states.size())
            hidden_states = attn(hidden_states)
