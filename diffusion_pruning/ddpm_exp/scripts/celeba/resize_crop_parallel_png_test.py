...
input_dir = '/raid/akshay/ashutosh/diffpruning2/ddpm_exp/run_logs/dataset_orig'
output_dir = '/raid/akshay/ashutosh/diffpruning2/ddpm_exp/run_logs/dataset_cropped_test'
target_size = (64, 64)
    ...
    if filename.endswith('.jpg'):
        try:
            ...
            if img is not None:
                ...
                cv2.imwrite(output_path, cropped_and_resized_img, [cv2.IMWRITE_PNG_COMPRESSION, 9])  # Save as PNG with max compression
            else:
