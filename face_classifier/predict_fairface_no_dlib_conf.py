...
def predidct_age_gender_race(save_prediction_at, imgs_path = 'cropped_faces/'):
    ...
    # age
    result.loc[result['age_preds_fair'] == 0, 'age'] = '0-2y'
    result.loc[result['age_preds_fair'] == 1, 'age'] = '3-9y'
...
if __name__ == "__main__":
    ...
    # SAVE_DETECTED_AT = "detected_faces_sample_dataset"
    ...
    predidct_age_gender_race(args.output_csv, args.image_dir)
